...
class PySideBackendTests(unittest.TestCase):
    ...
    def test_real_catalog_and_form_keep_bounds_and_post_capture_options(self):
        ...
        w.capture_checks[3].setChecked(True)
        w.capture_checks[4].setChecked(False)
        ...
        self.assertTrue(inputs.options.record_shiny_video)
        self.assertFalse(inputs.options.stop_on_non_target_shiny)
