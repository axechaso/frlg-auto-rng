...
截至 2026-08-13，现有测试共 76 项，73 项通过、3 项因本机未安装 OpenCV 跳过。它们覆盖计划择优、IV 输入、SID 采集请求与反查、御三家最低闪光目标和 SID 判定、Seed 模式、静态目标白名单、路线边界、1.1.8 参数替换、孵蛋参数、TID/SID 1.3.7 日英模板与标签、标签兼容、EasyCon 1.6.4a 预检和 GUI/CLI 识图取整兼容 runner。测试通过不等于 Switch 实机长跑已经验收。
